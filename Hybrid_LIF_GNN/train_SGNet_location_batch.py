# -*- coding: utf-8 -*`-
"""
Codes for Hybrid_LIF_GNN on event-driven object recognition v1 datasets, cw and ycb.
...
from tactileSGNet_location_batch import *
...
for run in range(num_run):
    ...
    # optimizer = torch.optim.RMSprop(model.parameters(), lr=learning_rate, weight_decay=0.5)
    # optimizer = torch.optim.SGD(model.parameters(), lr=learning_rate, weight_decay=0.5)
